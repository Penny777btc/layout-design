...
不用 AI 也行。下面 6 个功能点的 before/after，本身就是 6 张速查卡。

---

## 六个法则 · 每个都是一组 before / after

这些对比图本身就用了书里的版面法则来做（纸感、网格、大留白、单一朱红、宋体编辑标题）——**用版面讲版面**。

### 01 · 建立主次
![建立主次](images/01-hierarchy.png)
- **使用前**：信息全一样大，观众不知道先看哪。
- **使用后**：大中小字级拉开层级，一眼看到最重要那句。
...
- **使用前**：填满整屏，又挤又乱。
- **使用后**：大面积留白，把主体衬出来（源自水墨、侘寂的东方美学）。
- **视频里**：封面/缩略图给主标题足够留白，别塞满；想要"高级/安静"就加留白。

### 04 · 配色克制
![配色克制](images/04-color.png)
- **使用前**：颜色又多又杂，画面脏。
- **使用后**：一个主色 + 一抹强调色（数量对比＝最高级的对比）。
- **视频里**：配色超过"主色 + 2"就开始脏；重点信息用一点信号色顶出来。

### 05 · 重复与渐变
![重复与渐变](images/05-repeat.png)
- **使用前**：元素大小、位置随意。
- **使用后**：重复 + 大小渐变，排成韵律（日本设计最常用的手法）。
- **视频里**：一组同类元素靠重复+大小变化立刻产生主次和节奏。

### 06 · 图文分离
![图文分离](images/06-imagewrap.png)
- **使用前**：文字直接压在图上，互相打架、看不清。
- **使用后**：图归图、字归字，文字让位或绕图排列。
